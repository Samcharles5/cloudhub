...
function Feedback() {
  return (
    <section className="feedback py-16 bg-white animated-background" style={{backgroundImage: `url(${backgroundImage})`, backgroundSize: 'cover',backgroundPosition: 'center' }}>
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="right-content">
            <h2 className="text-3xl font-bold text-gray-800 mb-4 typing">Better feedback at the right time.</h2>
