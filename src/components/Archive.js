  ...
  return (
    ...
    >
      <div className="container mx-auto text-center px-4 md:px-0">
        <h2 className="text-xl md:text-2xl font-bold mb-2 md:mb-4 text-black typing">Your Archive of Progress</h2>
        <p className="mb-4 md:mb-8 text-black md:text-lg">Organize, filter, and archive your projects.</p>
        <div className="flex justify-center">
          <img src={img} alt="Archive" className="w-full md:w-auto   mx-auto bounce" /> // max-w-xs md:max-w-md
        </div>
      </div>
    </section>
  );
